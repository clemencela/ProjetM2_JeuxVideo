...
import csv
import re
with open("../data/CSV/vgsales-12-4-2019.csv","r",encoding="utf-8") as table, open("../data/CSV/plus_critic_sales.csv","a",encoding="utf-8") as out:
    ...
    for line in file:
        ...
        inter = [rank,name,basename,genre,platform,publisher,developer,critic,globalsa,usa,euro,jap,year]
        if "" not in inter:
